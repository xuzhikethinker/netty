...
public interface EventExecutorGroup extends ScheduledExecutorService, Iterable<EventExecutor> {
    ...
    /**
     * Returns the {@link Future} that becomes successful when this executor is shut down.
     */
    Future<?> shutdownFuture();

    /**
     * Shortcur method for {@link #shutdownGracefully(long, long, TimeUnit)} with sensible default values.
     */
